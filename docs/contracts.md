...
The emitted `DepositAllocated` event is the source event for the backend indexer. The indexer persists raw payloads, matches the pre-created intent, and only then invokes the existing double-entry ledger and Principal XP flow. The deployment registry under `packages/contracts/deployments/arc-testnet.json` records the real Arc Testnet deployment from block `63784132`; its addresses and transaction hashes were read from successful onchain receipts.
...
| --- | --- | --- |
| DepositRouter | `DEFAULT_ADMIN_ROLE` | `0xEC37B02109f0ab1ae2cf094eA328d24ae5c826E9` |
| DepositRouter | `ALLOCATOR_ROLE` | `0xEC37B02109f0ab1ae2cf094eA328d24ae5c826E9` |
| DepositRouter | `PAUSER_ROLE` | `0xEC37B02109f0ab1ae2cf094eA328d24ae5c826E9` |
| Each vault | `DEFAULT_ADMIN_ROLE` | `0xEC37B02109f0ab1ae2cf094eA328d24ae5c826E9` |
| Each vault | `TREASURY_ROLE` | `0xEC37B02109f0ab1ae2cf094eA328d24ae5c826E9` |
| Each vault | `PAUSER_ROLE` | `0xEC37B02109f0ab1ae2cf094eA328d24ae5c826E9` |
| Each vault | `ROUTER_ROLE` | `0x5Ae649A4218546753c5e99C4F39d84A38be24D08` |
