...
export const SYSTEM_CONFIG_DEFAULTS = {
  ...
  futuresStrategyCycleSeconds: 60,
  futuresMaxGrossExposure: '0.65',
  futuresMaxNetExposure: '0.50',
  futuresMaxMarginUsage: '0.50',
  futuresMaxOrderNotional: '25000',
  futuresTakerFeeBps: '6',
  futuresBaseSlippageBps: '5',
  futuresMaxSlippageBps: '50',
  futuresMaintenanceMarginRatio: '0.01',
  futuresLiquidationPenaltyBps: '50',
  futuresFundingRateLimit: '0.001',
  futuresMaxConsecutiveLosses: 3,
  futuresReducedRiskLeverage: '1.5',
  futuresDataStaleSeconds: 120,
  futuresStopAtrMultiple: '2',
  futuresTargetAtrMultiple: '4',
...
export const systemConfigSchema = z
  .object({
    ...
    futuresPaperTradingEnabled: z.boolean(),
    futuresStrategyCycleSeconds: z.number().int().min(30).max(3600),
    futuresMaxGrossExposure: ratioString,
    futuresMaxNetExposure: ratioString,
    futuresMaxMarginUsage: ratioString,
    futuresMaxOrderNotional: nonNegativeDecimalString,
    futuresTakerFeeBps: nonNegativeDecimalString,
    futuresBaseSlippageBps: nonNegativeDecimalString,
    futuresMaxSlippageBps: nonNegativeDecimalString,
    futuresMaintenanceMarginRatio: ratioString,
    futuresLiquidationPenaltyBps: nonNegativeDecimalString,
    futuresFundingRateLimit: ratioString,
    futuresMaxConsecutiveLosses: z.number().int().min(1).max(100),
    futuresReducedRiskLeverage: nonNegativeDecimalString,
    futuresDataStaleSeconds: z.number().int().min(1).max(3600),
    futuresStopAtrMultiple: nonNegativeDecimalString,
    futuresTargetAtrMultiple: nonNegativeDecimalString,
